...
## /home/gcharang/developer-docs-test/doxy/submodules/antara-gaming-sdk/modules/math/antara/gaming/math/vector.hpp
...
|                | Name           |
| -------------- | -------------- |
|  | **[REFL_AUTO](Files/vector_8hpp.md#function-refl_auto)**(type([antara::gaming::math::vec3f](Classes/classantara_1_1gaming_1_1math_1_1basic__vector.md)) , func(x) , func(y) , func(x_ref) , func(y_ref) , func(size) , func(set_x) , func(set_y) , func(set_z) , func(set_xyz) )  |
|  | **[REFL_AUTO](Files/vector_8hpp.md#function-refl_auto)**(type([antara::gaming::math::vec2f](Classes/classantara_1_1gaming_1_1math_1_1basic__vector.md)) , func(x) , func(y) , func(x_ref) , func(y_ref) , func(size) , func(set_x) , func(set_y) , func(set_xy) , func(make_xy) )  |
