...
## /home/gcharang/developer-docs-test/doxy/submodules/antara-gaming-sdk/modules/glfw/antara/gaming/glfw/graphic.system.cpp
...
namespace antara::gaming::glfw
{
    ...
    graphic_system::graphic_system(entt::registry& registry) : system(registry)
    {
        ...
        window_ = glfwCreateWindow(real_width, real_height, canvas_2d.window_title.c_str(), nullptr, nullptr);
        if (!window_)
        {
